...
print(f"Fastest Strategy: {test_driver.strategy_generator.best_strategy(dist_mode=True)}", end='\n\n')
...
print(f"Fastest One Stop: {test_driver.strategy_generator.best_one_stop}") #  alternative - test_driver.strategy.best_1_stop
print(f"Fastest Two Stop: {test_driver.strategy_generator.best_two_stop}") #  alternative - test_driver.strategy.best_2_stop
print(f"Fastest Three Stop: {test_driver.strategy_generator.best_three_stop}") #  alternative - test_driver.strategy.best_3_stop

# Plot the tyre performance models
test_driver.strategy_generator.plot_tyre_performance()
...
test_driver.strategy_generator.plot_strategy_performance(number_of_strategies=number_to_view)
